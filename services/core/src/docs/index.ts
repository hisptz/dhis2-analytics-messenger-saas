...
import { flowSchema, flowStateSchema } from "../apiSchemas/flow";
import { JobSchema, JobStatusSchema } from "../apiSchemas/job";
import { ScheduleSchema } from "../apiSchemas/schedule";
...
const apiDoc: OpenAPIObject = {
	...
	info: {
		...
		version,
		description:
			"An API service that provides chat-bot functionality as well as other useful services that power the DHIS2 Analytics messenger",
	},
	components: {
		schemas: {
