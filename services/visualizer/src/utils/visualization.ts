...
export function getLayout(visualization: any) {
	return {
...
export function getDefaultType(visualization: any) {
...
export function getChartType(type: string): string {
...
export function getConfig(visualization: any, { height }: { height: number }) {
...
export function getOrgUnits(visualization: any) {
...
export function getCategoryOptionGroupSets(visualization: any) {
...
export function getCategoryOptions(visualization: any) {
...
export function getOrganisationUnitGroupSetDimensions(visualization: any) {
